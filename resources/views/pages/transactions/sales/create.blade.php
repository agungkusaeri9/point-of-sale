                        ...
                        <div class="form-group row">
                            ...
                            <select name="customer_id" id="customer_id" class="form-control">
                                ...
                                @foreach ($customers as $customer)
                                    <option @if($customer->id === $customer) selected @endif value="{{ $customer->id }}">{{ $customer->name }}</option>
                                @endforeach
                            </select>
                            </div>
                        </div>
            ...
            <div class="col-md-4">
                <div class="info-box" style="min-height: 180px">
                    <div class="info-box-content text-right">
                        <h5 class="text-right">Invoice <span class="font-weight-bold" id="invoice">{{ $invoice }}</span></h5>
                ...
                <div class="info-box" style="min-height: 180px">
                    <div class="info-box-content">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                            <input type="text" class="form-control" id="sub_total"  readonly value="{{ $sub_total }}">
                            </div>
                        </div>
                        <div class="form-group row">
                ...
                <div class="info-box" style="min-height: 180px">
                    <div class="info-box-content">
                        <div class="form-group">
                            ...
                            <br>
                            <button class="btn btn-success" id="checkout"><i class="fas fa-shopping-cart"></i> Checkout</button>
                        </div>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-primary btn-sm" id="pilih"
                                        data-id="{{ $item->id }}" 
                                        data-barcode="{{ $item->barcode }}"><i class="fas fa-check"></i> Pilih</button>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
